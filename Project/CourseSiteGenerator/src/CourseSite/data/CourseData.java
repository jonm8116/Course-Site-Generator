...
public class CourseData implements AppDataComponent{
    ...
    CourseApp app;
    //INSTANTIATE A CONTROLLER OBJECT FOR TRANSACTIONS
...
//    }
    ...
    //PLACE LIST FOR STORING WEB PAGES 
    ObservableList<CourseSitePages> sitePages;

    public ObservableList<CourseSitePages> getSitePages() {
        return sitePages;
    }

    public void setSitePages(ObservableList<CourseSitePages> sitePages) {
        this.sitePages = sitePages;
    }
    //DATA STRUCTURE FOR COURSE TITLE AND LABELS
    ObservableList<String> courseTitle;
    
    //DATA STRUCTURE FOR SITE INFO
    ObservableList<SiteInfo> siteInfo;
    //DATA STRUCTURE FOR STUDENTS
    ObservableList<Student> students;
    //DATA STRUCTURE FOR TEAMS
    ObservableList<Team> teams;
    //DATA STRUCTURE FOR RECITATIONS
    ...
    //ALLOW VALUES TO GO PAST 9 AND 20
    public static final int MIN_START_HOUR = 0;     //origin: 9
    public static final int MAX_END_HOUR = 23;      //origin: 20
     ...
     */
    public CourseData(CourseApp initApp) {
        // KEEP THIS FOR LATER
        app = initApp;
        //INITIALIZE CONTROLLER
        //controller = new CourseController(initApp);
        
        // CONSTRUCT THE LIST OF TAs FOR THE TABLE
        teachingAssistants = FXCollections.observableArrayList();
        //INSTANTIATE SITE PAGES ARRAYLIST
        ...
        //INSTANTIATE TEAMS DATA STRUCTURE
        teams = FXCollections.observableArrayList();
        //INSTANTIATE STUDENTS DATA STRUCTURE
        students = FXCollections.observableArrayList();
        //INSTANTIATE SITE INFO DATA STRUCTURE
        siteInfo = FXCollections.observableArrayList();
        //INSTANTIATE COURSE TITLE
        courseTitle = FXCollections.observableArrayList();
        ...
        ArrayList<String> timeHeaders = props.getPropertyOptionsList(TAProp.OFFICE_HOURS_TABLE_HEADERS);
        ArrayList<String> dowHeaders = props.getPropertyOptionsList(TAProp.DAYS_OF_WEEK);
        gridHeaders = new ArrayList();
        gridHeaders.addAll(timeHeaders);
        gridHeaders.addAll(dowHeaders);
    }

    public ObservableList<SiteInfo> getSiteInfo() {
        return siteInfo;
    }
    ...
    public void setOfficeHours(HashMap<String, StringProperty> editedOfficeHours){
        officeHours = editedOfficeHours;
    }
    ...
    private void initOfficeHours(int initStartHour, int initEndHour) {
        ...
        workspaceComponent.getTADataTabPane().reloadOfficeHoursGrid(this);       //origin: workspaceComponent.reloadOfficeHoursGrid(this); 
    }
    ...
    public void removeTAFromCell(StringProperty cellProp, String taName) {
        ...
        else if (cellText.indexOf(taName) < cellText.indexOf("\n", cellText.indexOf(taName))) {    //change sign to < instead of <=
            int startIndex = cellText.indexOf("\n" + taName);
