...
public class AppGUI {
    ...
    //ADD INSTANCE FOR TABPANE
    protected TabPane tabPane;
    
    //INSTANCE OF COURSE WORKSPACE
    protected BorderPane workspacePane;
    ...
    private void initWindow() {
        ...
        //ADD TABPANE TO PROVIDE A MEANS OF ADDING TABS
        workspacePane = new BorderPane();
        tabPane = new TabPane();
        workspacePane.setCenter(tabPane);
        appPane.setCenter(workspacePane);     //origin: appPane.setCenter(tabPane);
        
        primaryScene = new Scene(appPane);  //origin: primaryScene = new Scene(appPane);
